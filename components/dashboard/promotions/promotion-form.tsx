...
/**
 * El formulario de promoción, uno solo para crear y para editar.
 *
 * Lo que se carga acá decide cuánto se descuenta de un pedido: las categorías
 * que forman la condición y cuántas unidades de cada una, el tope de
 * aplicaciones, y qué medios de pago y de envío acepta. Un pedido que no
 * califica por alguno de esos campos se rechaza entero, así que el formulario
 * es la única puerta para cargarlos bien.
 */

type PromotionFormProps = {
  categories: Category[] | null
  defaultValues: DefaultValues<PromotionSchema>
  guardar: (data: PromotionSchema) => Promise<ResultadoAccion>
