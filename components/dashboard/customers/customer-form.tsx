...
/**
 * El formulario de cliente, uno solo para crear y para editar.
 *
 * Un cliente puede tener varias direcciones, y cada una se guarda en campos
 * planos —calle, número, localidad— pero se edita como el objeto de georef.
 * Esa traducción de ida y vuelta vive en los envoltorios, que es donde importa
 * la diferencia entre un cliente nuevo y uno que ya existe.
 *
 * Ojo con el teléfono: el esquema lo declara opcional, pero un cliente nuevo
 * arranca con 0, que no es "sin teléfono" sino un número inválido.
 */

type CustomerFormProps = {
  defaultValues: DefaultValues<CustomerSchema>
  guardar: (data: CustomerSchema) => Promise<ResultadoAccion>
