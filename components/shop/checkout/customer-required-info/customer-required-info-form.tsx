...
type CheckoutCustomerRequiredInfoFormProps = {
  customer: PopulatedCustomer
  placeOrder: () => void
  setOpen: (open: boolean) => void
}

const CheckoutCustomerRequiredInfoForm = ({
  customer,
  placeOrder,
  setOpen,
}: CheckoutCustomerRequiredInfoFormProps) => {
...
export default CheckoutCustomerRequiredInfoForm
